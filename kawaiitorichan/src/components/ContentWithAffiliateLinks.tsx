...
export default function ContentWithAffiliateLinks({ postId, children }: ContentWithAffiliateLinksProps) {
  ...
  useEffect(() => {
    ...
    console.log(`Added ${linksAdded} affiliate links to the content`)
  }, [products])
